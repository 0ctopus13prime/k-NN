...
#include "method/hnsw_distfunc_opt.cc"
...
void knn_jni::nmslib_wrapper::CreateIndexLegacy(knn_jni::JNIUtilInterface *jniUtil, JNIEnv *env, jintArray idsJ,
                                          jlong vectorsAddressJ, jint dimJ,
