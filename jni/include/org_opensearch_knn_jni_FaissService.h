...
void Java_org_opensearch_knn_jni_FaissService_bulkScoring
  (uint64_t flatVectorsManagerAddress, float* query, uint32_t* neighborList, float* scores, uint32_t size, uint32_t dimension);
...
/*
 * Class:     org_opensearch_knn_jni_FaissService
 * Method:    allocateFlatVectorsManager
 * Signature: (Lorg/opensearch/knn/index/store/IndexInputWithBuffer;II)J
 */
...
/*
 * Class:     org_opensearch_knn_jni_FaissService
 * Method:    deallocateFlatVectorsManager
 * Signature: (J)V
 */
