 ...
 * in Lucene.
 */
public class FaissHnswGraph2 extends HnswGraph {
    ...
    private final NativeRandomVectorScorer2 scorer2;
    private final Arena arena;
    private final FixedBitSet visited;
    private int previousLevel;

    public FaissHnswGraph2(final FaissHNSW faissHNSW, final IndexInput indexInput, final NativeRandomVectorScorer2 scorer2) {
    ...
    public void seek(int level, int internalVectorId) {
        ...
        scorer2.bulkScoring(neighborIdList, numNeighbors);
    }
