...
/**
 * This factory returns {@link KnnVectorsReader} that performs vector search directly on FAISS index.
...
public class FaissMemoryOptimizedSearcherFactory implements VectorSearcherFactory {
    @Override
    public KnnVectorsReader createVectorSearcher(final Directory directory, final String fileName) throws IOException {
