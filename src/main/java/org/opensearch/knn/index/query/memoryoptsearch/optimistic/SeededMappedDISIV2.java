...
public class SeededMappedDISIV2 extends DocIdSetIterator {
    KnnVectorValues.DocIndexIterator indexedDISI;
    DocIdSetIterator sourceDISI;

    public SeededMappedDISIV2(KnnVectorValues.DocIndexIterator indexedDISI, DocIdSetIterator sourceDISI) {
